package com.example.neeharmb.simpletodo;
    ...
    private void setupListViewListener() {
        ...
        lvItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent newIntent = new Intent(MainActivity.this, EditItemActivity.class);
                // pass the data being edited to the activity
                newIntent.putExtra(ITEM_TEXT, items.get(i));
                newIntent.putExtra(ITEM_POSITION, i);
                // display the activity to the user
                startActivityForResult(newIntent, EDIT_REQUEST_CODE);
